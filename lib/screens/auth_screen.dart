  ...
  Future<void> _submit() async {
    ...
    try {
      ...
      if (Provider.of<Auth>(context, listen: false).token2 == 'patient') {
        Navigator.pushNamedAndRemoveUntil(context, '/patient', (r) => false);

        CommonFunctions.showSuccessToast('Login Successful Patient');
      } else if (Provider.of<Auth>(context, listen: false).token2 == 'doctor') {
        Navigator.pushNamedAndRemoveUntil(context, '/home', (r) => false);

        CommonFunctions.showSuccessToast('Login Successful Doctor');
      } else if (Provider.of<Auth>(context, listen: false).token2 ==
          'attendant') {
        Navigator.pushNamedAndRemoveUntil(context, '/attendant', (r) => false);

        CommonFunctions.showSuccessToast('Login Successful Attendant');
      }
